    ...
    <div className="welcome">
      ...
      <div className="welcome-content">
        <div className="welcome-brand">
          ...
          <h1 className="welcome-title">Te damos la bienvenida a Omega OSINT</h1>
          <p className="welcome-sub">
            Elige cómo quieres usar el mapa. Podrás cambiarlo más tarde desde
            el icono de ajustes en la pestaña Mapa.
          </p>
        </div>
        ...
        {step === 'choose' && (
          <div className="welcome-cards">
            ...
            >
              ...
              <div className="welcome-card-desc">
                Detalles de lugares más ricos (valoraciones, horarios, teléfono).
                Requiere una clave de API.
              </div>
              <span className="welcome-card-tag">Recomendado</span>
            </button>
          </div>
        )}
          ...
          >
            <div className="field">
              <label htmlFor="welcome-api-key">
                ...
                <span className="welcome-optional">(opcional)</span>
              </label>
              <input
                id="welcome-api-key"
                type="password"
              ...
              <p className="welcome-help">
                Puedes omitirlo por ahora — podrás pegar la clave en la pestaña
                Mapa cuando quieras. La clave se queda en este dispositivo.
              </p>
            </div>
            <div className="welcome-key-actions">
              ...
              <button type="submit" className="btn btn-primary">
                {apiKey.trim() ? 'Guardar clave y continuar' : 'Omitir por ahora'}
              </button>
            </div>
          </form>
        )}
